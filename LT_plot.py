...
def plot_results(file_name):
    ...
    plotter_instance = plotter.ComparisonPlotter(
        R_range, number_of_lines, model_name="LT"
    )
    ...
    plotter_instance.plot_spatial_panel(
        (0, 1), "Radial Stretch", "Stretch", plot_data["radial_strain"]
    )
    plotter_instance.plot_spatial_panel(
        (1, 1), "Hoop Stretch", "Stretch", plot_data["hoop_strain"]
    )
    plotter_instance.plot_spatial_panel(
    ...
    plotter_instance.plot_spatial_panel(
        ...
        "Hoop Growth",
        "Growth",
        plot_data["hoop_growth"],
        plot_data["Homeostasis"],
    )

    # Finalize and save
    plotter_instance.finalize_and_save("LT.png")
